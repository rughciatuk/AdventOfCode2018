...
def checksum2(table):
    ...
    sum = 0
    for row in table:
        sum = sum + checkrow(row)
    return sum


base = '''515	912	619	2043	96	93	2242	1385	2110	860	2255	621	1480	118	1230	99
...
for x in range(0, len(rows)):
    trueTable.append(rows[x].split(sep="\t"))

print(checksum2(trueTable))
